      ...
      return (
        <div className="min-h-[200px] flex flex-col items-center justify-center gap-3 rounded-xl border border-red-500/20 bg-red-500/5 p-8">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-lg border border-slate-700 text-slate-400 text-xs font-medium hover:bg-slate-800 transition-colors"
          >
            <RefreshCw size={12} />
            다시 시도
          </button>
