...
### 레벨별 난이도 기준
| 레벨 | 슬롯 수 | 오답 수 | 오답 유형 | 힌트 | 소재 |
|------|---------|---------|-----------|------|------|
| 1 | 3 | 1 | 왜곡형 | 3개 | 일상/기초 인과 |
| 2 | 3 | 1 | 왜곡형 | 3개 | 부분 추상 개념 |
| 3 | 4 | 1 | 왜곡형 | 3개 | 수식어/종속절 포함 |
| 4 | 4 | 1 | 유사 정답형 | 3개 | 모의고사 수준 |
| 5 | 5 | 1 | 유사 정답형 | 3개 | 대조/역전 논리 |
| 6 | 5 | 2 | 혼합 (왜곡+유사) | 3개 | 수능 실전 |
| 7 | 5 | 2 | 혼합 (왜곡+유사) | 없음 | 고난도 추상 |
